...
This is a basic example of fitting a Gaussian kernel ridge regression estimator to a dataset ${(x_i, y_i)}_{i=1}^n$ using (1) exact computation, (2) the Nyström approximation, (3) pivoted Cholesky decomposition, and (4) random Fourier features.
