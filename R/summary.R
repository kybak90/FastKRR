...
#' Summary method for approximated kernel matrices
#'
#' @description
...
#'
#' @seealso \code{\link{approx_kernel}, \link{summary.krr}}, \code{\link{summary.kernel_matrix}}
#'
#' @examples
#' # Data setting
#' set.seed(1)
...
#'
#' @export
summary.approx_kernel = function(x, ...){
  approx_object = x
  cat("Call:\n")
  print(attributes(approx_object)$call)
  cat("\n")
  print(attributes(approx_object)$K_approx) ## summary.kernel_matrix()
  cat("\n")
...
#' Summary method for kernel matrices
#'
#' @description
...
#'
#' @seealso \code{\link{approx_kernel}}, \code{\link{fastkrr}}, \code{\link{summary.approx_kernel}},
#' \code{\link{summary.krr}}
#'
#' @examples
#' # data setting
#' set.seed(1)
...
#' summary(class(attr(fit_pivoted, "K")))
#'
#' class(attr(fit_pivoted, "K_approx"))
#' summary(class(attr(fit_pivoted, "K_approx")))
#'
#'
...
#' summary(attr(K_rff, "K_approx"))
#' @export
summary.kernel_matrix = function(x, ...){
  ker_mat = x
